...
export const selectGroupNextPageLoading = (s: LoadingStore) => s.group.nextPage === 'loading';
...
export const selectGroupCoverUploading = (s: LoadingStore) => s.group.cover === 'loading';
